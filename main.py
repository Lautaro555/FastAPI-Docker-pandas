...
df=pd.read_csv("https://github.com/Lautaro555/FastAPI-Docker-pandas/raw/main/Data_cleansing/df.csv",sep=",",dtype=type).drop('Unnamed: 0', axis=1)
...
@app.get("/get-listedin/{platform-year}")
